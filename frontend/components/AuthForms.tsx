...
export const LoginForm: React.FC<FormProps> = ({ onSuccess, onSwitchToRecover, onGoogleLogin }) => {
  ...
  return (
    ...
    >
      <div className="mb-6 text-left">
        ...
        <p className="text-slate-500 mt-1">Accedi per gestire la tua filiera.</p>
      </div>
      ...
      <motion.button
        ...
        className="w-full flex justify-center items-center gap-3 bg-white border border-slate-200 text-slate-700 font-semibold py-3.5 rounded-xl shadow-sm hover:bg-slate-50 transition-all mb-6"
      >
...
export const RegisterForm: React.FC<FormProps> = ({ onSuccess, onGoogleLogin }) => {
  return (
    <motion.div 
      initial={{ opacity: 0, x: -20 }}
      animate={{ opacity: 1, x: 0 }}
    ...
    >
      <div className="mb-6 text-left">
        ...
        <p className="text-slate-500 mt-1">Unisciti alla rete FruttaGest.</p>
      </div>
